...
- [ ] **UX-01**: TaskBoard 空状态引导：无任务时显示「开启你的第一个任务」标题 + 创建按钮 CTA
- [ ] **UX-02**: IMPanel（会话列表）空状态引导：无会话时显示「开始新对话」引导 CTA
- [ ] **UX-03**: AvatarListPanel 模板快速创建：无 avatar 时「一键创建」5 个内置模板按钮
- [ ] **UX-04**: McpPanel 空状态引导：无 server 时显示添加引导 + 快速模板入口
- [ ] **UX-05**: ChatView 加载骨架屏：AI 响应时输入区域上方显示消息骨架屏
- [ ] **UX-06**: 快捷键 Cmd+,（macOS 标准）打开设置面板，替换当前的点击入口
- [ ] **UX-07**: Escape 键关闭当前打开的 Modal/面板（LIFO 栈顺序）
- [ ] **UX-08**: Cmd+Shift+S 收起/展开侧边栏
- [ ] **UX-09**: Cmd+/ 打开快捷键参考页（显示所有可用快捷键）
